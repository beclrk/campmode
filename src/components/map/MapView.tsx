...
function MapZoomControls() {
  const map = useMap();
  return (
    <div className="absolute bottom-[calc(var(--app-promo-banner-height,72px)+8rem+env(safe-area-inset-bottom,0px))] right-4 md:bottom-[calc(var(--app-promo-banner-height,72px)+1rem+env(safe-area-inset-bottom,0px))] z-[1100] flex flex-col gap-1 rounded-xl overflow-hidden shadow-lg border border-neutral-700 bg-neutral-900/95 backdrop-blur-sm">
      <button
        type="button"
        onClick={() => map.zoomIn()}
...
function MapLayerControl({
  ...
  return (
    <div ref={ref} className="absolute bottom-[calc(var(--app-promo-banner-height,72px)+8rem+env(safe-area-inset-bottom,0px))] left-4 md:bottom-[calc(var(--app-promo-banner-height,72px)+1rem+env(safe-area-inset-bottom,0px))] z-[1100]">
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
